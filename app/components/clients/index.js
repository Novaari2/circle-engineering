...
import Gambar from "@/app/data/gambar";

const Client = () => {
    let img = ['erp.png','global-perkasa.jpeg','haistar.jpeg','juki.jpeg','OJK.jpeg','stefanie.png'];
      ...
      {img.map((imageName, index) => (
        <div key={index} className="px-2">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="relative h-60 sm:h-80 md:h-60 lg:h-80">
